...
OUTPUT_DIR = build_output_dir(
    BASE_CONFIG,
    extra_cfgs=[PARTITION_CONFIG, DUAL_DP_CONFIG],
    prefix="dual_dp_noniid"
)
...
def main():
    ...
    wait_convergence(nodes, NODES - 1, only_direct=False, wait=120)

    # ========================
    # TRAIN
    # ========================
    nodes[0].set_start_learning(rounds=ROUNDS, epochs=EPOCHS, trainset_size=NODES)
    wait_to_finish(nodes, timeout=3600*3)
